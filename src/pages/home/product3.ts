...
export class ProductsPage1 {
  ...
  constructor(public navCtrl: NavController, public modalCtrl: ModalController, private navpar : NavParams,
    private productsProvider    :    ProductsProvider, private loading : LoadingController,public menuCtrl:MenuController,public viewCtrl:ViewController,
    ) {
...
loadProducts() {
  ...
  this.productsProvider.getProductwithMasterimages(this.start,this.end).subscribe(
      productsResponse     => {
         loading.dismiss();
...
search(){
  ...
  console.log("Small",Small);
   if(val == ''){
    ...
    loading.present();
         this.productsProvider.getProductNameForMasterSearch(s).subscribe(
           data => {
                    ...
                    loading.dismiss();
                    this.productsProvider.getProductNameForMasterSearch(Small).subscribe(
                         data => {
                                  ...
                                  this.productsProvider.getProductNameForMasterSearch(Capital).subscribe(
                                             data => {
