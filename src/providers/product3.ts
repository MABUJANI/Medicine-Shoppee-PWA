...
// @Injectable()
// export class ProductsProvider1 {
//      employename : any;
//      salesorderno : any;
//      stackTrace = [];
...
//         getProductwithimages(start,end):any {
//             let endPoint            =     'Product';
//             let queryParams         =     "&_where=productCategory.name=%27"+"%27&_selectedProperties=id,name,phPhoto,uOM,taxCategory,standardCost,phPackage&_startRow="+start+"&_endRow="+end;
//             return                        this.utilityProvider.getOB3Object(endPoint,queryParams);
//         }
...
//             var queryParams ="&_where=productCategory.name=%27"+"%27%20and%20name%20like%20%27%25" + search + "%25%27%20and%20" + condition+"&_selectedProperties=id,name,phPhoto,uOM,taxCategory,standardCost,phPackage";
